% Written by Demitri Muna.
% Based on this StackExchange answer:
% https://tex.stackexchange.com/questions/537573/how-can-i-draw-great-circles-on-a-diagram-using-specific-coordinates-with-arbitr/537948?noredirect=1#comment1363556_537948
...
\tikzset{great circle arc/.cd,
    ...
    back/.style={draw=gray,thick,dashed,opacity=0.55}}
...
\begin{scope}[tdplot_main_coords]
	...
	% rear face
	\coordinate (E) at (-\rzero, \rzero, -\rzero);
	\coordinate (F) at (-\rzero, \rzero, \rzero);
	\coordinate (G) at (-\rzero, -\rzero, \rzero);
	\coordinate (H) at (-\rzero, -\rzero, -\rzero);
